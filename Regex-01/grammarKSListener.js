...
// Enter a parse tree produced by grammarKSParser#start.
grammarKSListener.prototype.enterStart = function(ctx) {
};

// Exit a parse tree produced by grammarKSParser#start.
grammarKSListener.prototype.exitStart = function(ctx) {
};
...
// Enter a parse tree produced by grammarKSParser#user_func_call.
grammarKSListener.prototype.enterUser_func_call = function(ctx) {
};

// Exit a parse tree produced by grammarKSParser#user_func_call.
grammarKSListener.prototype.exitUser_func_call = function(ctx) {
};


// Enter a parse tree produced by grammarKSParser#optional_exprlist.
grammarKSListener.prototype.enterOptional_exprlist = function(ctx) {
};

// Exit a parse tree produced by grammarKSParser#optional_exprlist.
grammarKSListener.prototype.exitOptional_exprlist = function(ctx) {
};


// Enter a parse tree produced by grammarKSParser#exprlist.
grammarKSListener.prototype.enterExprlist = function(ctx) {
};

// Exit a parse tree produced by grammarKSParser#exprlist.
grammarKSListener.prototype.exitExprlist = function(ctx) {
};
