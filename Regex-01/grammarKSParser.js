...
grammarKSParser.COMMENT = 1;
grammarKSParser.SEMI = 2;
...
grammarKSParser.LBR = 9;
grammarKSParser.RBR = 10;
grammarKSParser.FPNUM = 11;
grammarKSParser.NUM = 12;
grammarKSParser.OR = 13;
grammarKSParser.AND = 14;
grammarKSParser.NOT = 15;
grammarKSParser.RELOP = 16;
grammarKSParser.EQ = 17;
grammarKSParser.PLUS = 18;
grammarKSParser.MULOP = 19;
grammarKSParser.MINUS = 20;
grammarKSParser.CMA = 21;
grammarKSParser.TYPE = 22;
grammarKSParser.STRING_CONSTANT = 23;
grammarKSParser.PRINT = 24;
grammarKSParser.INPUT = 25;
grammarKSParser.OPEN = 26;
grammarKSParser.READ = 27;
grammarKSParser.WRITE = 28;
grammarKSParser.CLOSE = 29;
grammarKSParser.ID = 30;
grammarKSParser.WHITESPACE = 31;

grammarKSParser.RULE_start = 0;
grammarKSParser.RULE_program = 1;
grammarKSParser.RULE_stmts = 2;
grammarKSParser.RULE_stmt = 3;
grammarKSParser.RULE_loop = 4;
grammarKSParser.RULE_cond = 5;
grammarKSParser.RULE_braceblock = 6;
grammarKSParser.RULE_return_stmt = 7;
grammarKSParser.RULE_expr = 8;
grammarKSParser.RULE_orexp = 9;
grammarKSParser.RULE_andexp = 10;
grammarKSParser.RULE_notexp = 11;
grammarKSParser.RULE_rel = 12;
grammarKSParser.RULE_sum = 13;
grammarKSParser.RULE_term = 14;
grammarKSParser.RULE_neg = 15;
grammarKSParser.RULE_factor = 16;
grammarKSParser.RULE_var_decl_list = 17;
grammarKSParser.RULE_var_decl = 18;
grammarKSParser.RULE_assign = 19;
grammarKSParser.RULE_func_call = 20;
grammarKSParser.RULE_user_func_call = 21;
grammarKSParser.RULE_optional_exprlist = 22;
grammarKSParser.RULE_exprlist = 23;
grammarKSParser.RULE_builtin_func_call = 24;
...
function StartContext(parser, parent, invokingState) {
    ...
    this.parser = parser;
    this.ruleIndex = grammarKSParser.RULE_start;
    return this;
}
...
StartContext.prototype.EOF = function() {
    return this.getToken(grammarKSParser.EOF, 0);
};
...
grammarKSParser.StartContext = StartContext;

grammarKSParser.prototype.start = function() {

    var localctx = new StartContext(this, this._ctx, this.state);
    this.enterRule(localctx, 0, grammarKSParser.RULE_start);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 50;
        this.program();
        this.state = 51;
        this.match(grammarKSParser.EOF);
    } catch (re) {
...
grammarKSParser.prototype.program = function() {
    ...
    this.enterRule(localctx, 2, grammarKSParser.RULE_program);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 53;
        this.var_decl_list();
...
grammarKSParser.prototype.stmts = function() {
    ...
    this.enterRule(localctx, 4, grammarKSParser.RULE_stmts);
    try {
        this.state = 60;
...
grammarKSParser.prototype.stmt = function() {
    ...
    this.enterRule(localctx, 6, grammarKSParser.RULE_stmt);
    try {
        this.state = 73;
        this._errHandler.sync(this);
...
grammarKSParser.prototype.loop = function() {
    ...
    this.enterRule(localctx, 8, grammarKSParser.RULE_loop);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 75;
...
grammarKSParser.prototype.cond = function() {
    ...
    this.enterRule(localctx, 10, grammarKSParser.RULE_cond);
    try {
        this.state = 95;
        this._errHandler.sync(this);
...
grammarKSParser.prototype.braceblock = function() {
    ...
    this.enterRule(localctx, 12, grammarKSParser.RULE_braceblock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 97;
...
grammarKSParser.prototype.expr = function() {
    ...
    this.enterRule(localctx, 16, grammarKSParser.RULE_expr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 104;
        this.orexp(0);
...
grammarKSParser.prototype.orexp = function(_p) {
    ...
    var _startState = 18;
    this.enterRecursionRule(localctx, 18, grammarKSParser.RULE_orexp, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 107;
        this.andexp(0);
...
grammarKSParser.prototype.andexp = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 20;
    this.enterRecursionRule(localctx, 20, grammarKSParser.RULE_andexp, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 118;
        this.notexp();
...
grammarKSParser.prototype.notexp = function() {
    ...
    this.enterRule(localctx, 22, grammarKSParser.RULE_notexp);
    try {
        this.state = 131;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
grammarKSParser.prototype.rel = function() {
    ...
    this.enterRule(localctx, 24, grammarKSParser.RULE_rel);
    try {
        this.state = 138;
        this._errHandler.sync(this);
...
grammarKSParser.prototype.sum = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 26;
    this.enterRecursionRule(localctx, 26, grammarKSParser.RULE_sum, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 141;
        this.term(0);
...
grammarKSParser.prototype.term = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 28;
    this.enterRecursionRule(localctx, 28, grammarKSParser.RULE_term, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 155;
        this.neg();
...
grammarKSParser.prototype.neg = function() {
    ...
    this.enterRule(localctx, 30, grammarKSParser.RULE_neg);
    try {
        this.state = 168;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
FactorContext.prototype.FPNUM = function() {
    return this.getToken(grammarKSParser.FPNUM, 0);
};
...
grammarKSParser.prototype.factor = function() {
    ...
    this.enterRule(localctx, 32, grammarKSParser.RULE_factor);
    try {
        this.state = 179;
        this._errHandler.sync(this);
        ...
        case 3:
            this.enterOuterAlt(localctx, 3);
            this.state = 175;
            this.match(grammarKSParser.FPNUM);
            break;
...
grammarKSParser.prototype.var_decl_list = function() {
    ...
    this.enterRule(localctx, 34, grammarKSParser.RULE_var_decl_list);
    try {
        this.state = 186;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
grammarKSParser.prototype.var_decl = function() {
    ...
    this.enterRule(localctx, 36, grammarKSParser.RULE_var_decl);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 188;
...
grammarKSParser.prototype.assign = function() {
    ...
    this.enterRule(localctx, 38, grammarKSParser.RULE_assign);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 191;
        this.match(grammarKSParser.ID);
...
grammarKSParser.prototype.func_call = function() {
    ...
    this.enterRule(localctx, 40, grammarKSParser.RULE_func_call);
    try {
        this.state = 197;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
function User_func_callContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = grammarKSParser.RULE_user_func_call;
    return this;
}
...
grammarKSParser.User_func_callContext = User_func_callContext;

grammarKSParser.prototype.user_func_call = function() {

    var localctx = new User_func_callContext(this, this._ctx, this.state);
    this.enterRule(localctx, 42, grammarKSParser.RULE_user_func_call);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 199;
        this.match(grammarKSParser.ID);
...
function Optional_exprlistContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = grammarKSParser.RULE_optional_exprlist;
    return this;
}
...
grammarKSParser.Optional_exprlistContext = Optional_exprlistContext;

grammarKSParser.prototype.optional_exprlist = function() {

    var localctx = new Optional_exprlistContext(this, this._ctx, this.state);
    this.enterRule(localctx, 44, grammarKSParser.RULE_optional_exprlist);
    try {
        this.state = 206;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
        case grammarKSParser.RP:
            this.enterOuterAlt(localctx, 1);
...
function ExprlistContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = grammarKSParser.RULE_exprlist;
    return this;
}
...
grammarKSParser.prototype.exprlist = function(_p) {
	if(_p===undefined) {
	    _p = 0;
	}
    var _parentctx = this._ctx;
    ...
    var _prevctx = localctx;
    var _startState = 46;
    this.enterRecursionRule(localctx, 46, grammarKSParser.RULE_exprlist, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 209;
        this.expr();
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                this.pushNewRecursionContext(localctx, _startState, grammarKSParser.RULE_exprlist);
                this.state = 211;
                if (!( this.precpred(this._ctx, 2))) {
                    throw new antlr4.error.FailedPredicateException(this, "this.precpred(this._ctx, 2)");
                }
...
grammarKSParser.prototype.builtin_func_call = function() {
    ...
    this.enterRule(localctx, 48, grammarKSParser.RULE_builtin_func_call);
    try {
        this.state = 249;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
grammarKSParser.prototype.exprlist_sempred = function(localctx, predIndex) {
	switch(predIndex) {
		case 5:
			return this.precpred(this._ctx, 2);
		default:
