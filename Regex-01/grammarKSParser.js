...
var literalNames = [ null, "';'", null, "'while'", "'else'", "'return'", 
                     "'print'", "'input'", "'open'", "'close'", "'read'", 
                     "'write'", "'('", "')'", "'if'", "','", "'{'", "'}'", 
                     null, "'or'", "'and'", "'not'", null, "'='", "'+'", 
                     null, "'-'" ];

var symbolicNames = [ null, "SEMI", "COMMENT", "WHILE", "ELSE", "RETURN", 
                      "PRINT", "INPUT", "OPEN", "CLOSE", "READ", "WRITE", 
                      "LP", "RP", "IF", "CMA", "LBR", "RBR", "NUM", "OR", 
...
grammarKSParser.ELSE = 4;
grammarKSParser.RETURN = 5;
grammarKSParser.PRINT = 6;
grammarKSParser.INPUT = 7;
grammarKSParser.OPEN = 8;
grammarKSParser.CLOSE = 9;
grammarKSParser.READ = 10;
grammarKSParser.WRITE = 11;
grammarKSParser.LP = 12;
grammarKSParser.RP = 13;
grammarKSParser.IF = 14;
